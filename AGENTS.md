...
This project is indexed by GitNexus as **SMSytem** (1904 symbols, 4207 relationships, 154 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
