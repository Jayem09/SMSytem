...
type StockTransfer struct {
	...
	SourceBranchID      uint                `gorm:"not null;index:idx_source_status" json:"source_branch_id"`
	DestinationBranchID uint                `gorm:"not null;index:idx_dest_status" json:"destination_branch_id"`
	...
	Status              string              `gorm:"size:20;not null;default:'pending';index:idx_source_status;index:idx_dest_status" json:"status"`
